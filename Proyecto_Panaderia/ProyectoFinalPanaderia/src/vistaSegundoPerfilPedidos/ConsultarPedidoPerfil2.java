 ...
 * @author PIPE
 */
public class ConsultarPedidoPerfil2 extends javax.swing.JFrame {
...
private String formatearFecha(String fecha) {
    ...
    private void initComponents() {
        ...
        tblPedidos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Marca", "Producto", "Cantidad", "Fecha Pedido", "Fecha Entrega", "Precio", "Total", "Cancelado"
            }
        ) {
  ...
  int filaSeleccionada = tblPedidos.getSelectedRow();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarPedidoPerfil2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarPedidoPerfil2().setVisible(true);
            }
        });
    }
