...
public class ActualizarPerfil extends javax.swing.JFrame {
    ...
    public void traerID(int id) {
        idPerfil = id;
        txtId.setText(String.valueOf(idPerfil));
    ...
    public void cargarDatos(int id) {
        perfil = controlador.BuscarIdPerfil(idPerfil);
        if (this.perfil != null) {
    ...
    private void jbAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAceptarActionPerformed
        Perfil perfilModificado = new Perfil(Integer.valueOf(txtId.getText()),
                txtNombre.getText(),
                txtDescripcion.getText());

        if (txtNombre.getText().length() > 0 && txtDescripcion.getText().length() > 0) {
            if (controlador.ActualizarPerfil(perfilModificado)) {
